    ...
    <v-layout>
      ...
      <v-navigation-drawer v-model="drawer" temporary v-if="isLoggedIn">
        ...
        <v-list density="compact" nav>
          ...
          <a style="text-decoration: none;" href="https://arpesam.github.io/bdl-landingpage/#contact" target="_blank"><v-list-item prepend-icon="mdi-information" title="Quem Somos" value="Quem Somos"></v-list-item></a>
