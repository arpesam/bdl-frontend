...
function returnMiddleware(suggestion = {}, exams = {}) {
  ...
  console.log("b12: ", b12 ,"folic_acid: ", folic_acid ,"suggestion.isGroup3Filled", suggestion.isGroup3Filled);
  if (b12 && folic_acid && suggestion.isGroup3Filled) {
...
function processGroup3(exams, group2Suggestion) {
  ...
  // (VCM_GT_100 && HCM_GT_27 && !hasHemoglobinopatia)
  if (g2s.flow.includes('G2-5') && leococites == "≥4000" && plaquetas == "≥100" && !hasCronicHepatopatia) {
    return {
      ...group2Suggestion,
